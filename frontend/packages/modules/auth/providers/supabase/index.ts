...
import { Service as UserProfileService } from '@app-launch-kit/modules/user-profile/providers/supabase';
...
export const Service: IAuthService = {
  async signUpWithEmailPassword(
    ...
    try {
      ...
      if (response && originalResponse.data.user) {
        const { error } = await UserProfileService.updateUserProfile(
          originalResponse.data.user.id
        );
      }
